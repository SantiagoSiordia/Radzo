...
<body>
   ...
   <div class="singup-banner d-flex align-items-center">
      <div class="container mx-auto col-3 rounded p-3">
         <form action="CreateConsumablesController" class="login-form login-banner" method="post">
            <h1 class="text-white">Agregar Consumibles</h1>
            ...
            <textarea class="form-control mb-3" id="txtDescription" name="txtDescription" placeholder="Descripción" rows="10" cols="20"></textarea>
